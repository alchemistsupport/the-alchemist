  ...
  const preparedData = [
    {
      ...
      alt: data[0].image.data.attributes.name as string,
      src: data[0].image.data.attributes.url as string,
    },
    {
      link: data[1].url,
      bgColor: 'bg-charon',
      ...
      alt: data[1].image.data.attributes.name as string,
      src: data[1].image.data.attributes.url as string,
    },
    {
      link: data[2].url,
      ...
      alt: data[2].image.data.attributes.name as string,
      src: data[2].image.data.attributes.url as string,
    },
  ];
